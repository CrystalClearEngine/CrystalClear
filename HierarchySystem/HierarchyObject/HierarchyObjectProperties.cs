...
{
	/// <summary>
	///     A HierarchyObject is an object that exists in a Hierarchy, can have child objects and which can have
	///     HierarchyScripts attached.
	/// </summary>
		...
		// TODO: probably limit certain chars on names, such as \ / < > etc.
	{
		...
		/// </summary>
		public bool IsLoadedHierarchy => HierarchyManager.LoadedHierarchies.Values.Contains(Root);
		...
		public string HierarchyName
		{
			...
			set => HierarchyManager.SetHierarchyName(Root, value);
		}

		/// <summary>
		///     Returns the name of this HierarchyObject by looking it up via GetName() on the parent (or HierarchyManager if this
		///     HierarchyObject is the root). This property supports setting the name, which uses the SetName() method on the
		///     parent or HierarchyManager if this Hierarchy object is the root.
		/// </summary>
		public string Name
		{
			get
