...
namespace CrystalClear.HierarchySystem
{
		...
		, INotifyPropertyChanged
	{
		...
		/// <summary>
		/// This event is raised when a change in the Hierarchy has been made, such as changing the value of a child, or adding or removing a child.
		/// </summary>
		...
		{
			bool success = hierarchy.Remove(childName);
			OnHierarchyChange();
			return success;
		}
