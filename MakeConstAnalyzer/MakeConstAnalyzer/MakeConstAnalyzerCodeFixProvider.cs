...
{
	[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MakeConstAnalyzerCodeFixProvider)), Shared]
	public class MakeConstAnalyzerCodeFixProvider : CodeFixProvider
	{
		private const string title = "Make constant";

		public sealed override ImmutableArray<string> FixableDiagnosticIds
		{
			get { return ImmutableArray.Create(MakeConstAnalyzerAnalyzer.DiagnosticId); }
		}
