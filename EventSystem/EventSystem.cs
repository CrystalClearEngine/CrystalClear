	...
	public static class EventSystem
	{
		...
		public static void UnsubscribeEvents(Type typeToUnsubscribe, object instance)
		{
				...
				BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic))
			{
				...
				subscribeToAttribute?.ScriptEvent.Unsubscribe(
					(ScriptEventHandler) method.CreateDelegate(typeof(ScriptEventHandler), instance));
			}
		}
		...
		public static void SubscribeMethod(MethodInfo method, object instance)
		{
			...
			if (!(subscribeToAttribute is null))
			{
				...
				{
					throw new Exception(
						$"The event method {method.Name} contains generic parameters while the event type does not.");
				}

				if (method.ReturnType != typeof(void))
				{
					throw new Exception(
						$"The event method {method.Name} has a return type of {method.ReturnType.Name}, which is not void.");
				}
#endif
		...
		public static void FindAndSubscribeStaticEventMethods(Assembly assembly)
		{
			FindAndSubscribeStaticEventMethods(assembly.GetTypes());
		}
