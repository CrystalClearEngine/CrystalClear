...
namespace CrystalClear.EventSystem
{
	public static class EventSystem
	{
		...
		{
			foreach (MethodInfo method in typeToSubscribe.GetMethods(BindingFlags.Public | BindingFlags.NonPublic))
			{
		...
		{
			foreach (MethodInfo method in typeToUnsubscribe.GetMethods(BindingFlags.Public | BindingFlags.NonPublic))
			{
				SubscribeToAttribute subscribeToAttribute = method.GetCustomAttribute<SubscribeToAttribute>();
